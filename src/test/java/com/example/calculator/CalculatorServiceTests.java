...
class CalculatorServiceTests {
	...
	void shouldReturn25When10Plus15() {
		Assertions.assertEquals(25, service.plus(10, 15));
	}

	@Test
	void shouldReturn0When5Minus5() {
		Assertions.assertEquals(0, service.minus(5, 5));
	}

	@Test
	void shouldReturn10When15Minus5() {
		Assertions.assertEquals(10, service.minus(15, 5));
	}
	...
	void shouldReturn0When5Multiply0() {
		Assertions.assertEquals(0, service.multiply(5, 0));
	}

	@Test
	void shouldReturn1When5Divide5() {
		Assertions.assertEquals(1, service.divide(5, 5));
	}

	@Test
	void shouldReturn5When10Divide2() {
		Assertions.assertEquals(5, service.divide(10, 2));
	}
